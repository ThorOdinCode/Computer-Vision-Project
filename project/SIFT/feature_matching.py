...
DEFAULT_OUTPUT_DIR = PROJECT_DIR / "SIFT" / "matching"
...
def match_features(
    ...
    """
    Match descriptors using L2 distance and Lowe's ratio test.
    """
...
def process_pair(
    ...
    """
    Run SIFT feature extraction and matching for one
...
def run_matching(
    ...
    print("=" * 70)
    print("HPatches SIFT Feature Matching")
    print("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Run SIFT feature matching on HPatches "
