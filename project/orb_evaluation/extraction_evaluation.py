...
from feature_extraction import create_orb, process_sample_sequence
...
def plot_keypoint_counts(lighting_results, viewpoint_results, output_path):
    ...
    ax.set_title("ORB Keypoints per Image")
...
def plot_runtime_counts(lighting_results, viewpoint_results, output_path):
    ...
    ax.set_title("ORB Extraction Runtime per Image")
    ax.set_xlabel("Image number")
...
def run_extraction_evaluation(
    ...
    """
    Run ORB extraction on two sample sequences and create plots.
    """
    ...
    print(f"  Lighting sample grid: {lighting_output / f'{lighting_sequence}_orb_grid.png'}")
    print(f"  Viewpoint sample grid: {viewpoint_output / f'{viewpoint_sequence}_orb_grid.png'}")
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Create simple ORB extraction evaluation plots for lighting and "
            "viewpoint sequences."
        )
    )
    parser.add_argument(
